            ...
            <div id="authorize" class="authorize">
                <ul>
                    <?php global $user; 
                      if ($user->uid != 0) 
                      { 
                        print '<li class="user_signin">' .t(''). '<a href="' .url('user/'.$user->uid). '">' .$user->name. '</a></li>'; 
                        print '<li class="logout_register"><a href="' .url('user/logout'). '">' .t('sign out'). '</a></li>'; 
                      }
                      else 
                      { 
                        print '<li class="user_signin"><a href="' .url('user/'). '">' .t('Sign in'). '</a></li>'; 
                        print '<li class="logout_register"><a href="' .url('user/register'). '">' .t('Register'). '</a></li>'; 
                      } 
                    ?>
                </ul>
            </div>
